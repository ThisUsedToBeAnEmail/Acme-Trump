# This Makefile is for the Acme::Trump extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Acme/Trump.pm]
...
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Acme/Trump.pm]
#     clean => { FILES=>q[Acme-Trump-*] }
...
PARENT_NAME = Acme
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Acme/Trump.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Acme/Trump.pm \
	lib/Acme/Trump/Base.pm \
	lib/Acme/Trump/Motivational.pm \
	lib/Acme/Trump/Outrageous.pm

PM_TO_BLIB = lib/Acme/Trump.pm \
	blib/lib/Acme/Trump.pm \
	lib/Acme/Trump/Base.pm \
	blib/lib/Acme/Trump/Base.pm \
	lib/Acme/Trump/Motivational.pm \
	blib/lib/Acme/Trump/Motivational.pm \
	lib/Acme/Trump/Outrageous.pm \
	blib/lib/Acme/Trump/Outrageous.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Acme/Trump.pm $(INST_MAN3DIR)/Acme::Trump.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The great new Acme::Trump!'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Acme-Trump' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The great new Acme::Trump!",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Acme-Trump",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Acme::Trump!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Robert Acock &lt;thisusedtobeanemail@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Acme/Trump.pm blib/lib/Acme/Trump.pm \
	  lib/Acme/Trump/Base.pm blib/lib/Acme/Trump/Base.pm \
	  lib/Acme/Trump/Motivational.pm blib/lib/Acme/Trump/Motivational.pm \
	  lib/Acme/Trump/Outrageous.pm blib/lib/Acme/Trump/Outrageous.pm 
